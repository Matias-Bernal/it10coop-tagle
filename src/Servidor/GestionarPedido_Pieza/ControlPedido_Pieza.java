...
<<<<<<< .mine
	public void modificarPedido_Pieza(Long id, Pedido_PiezaDTO modificado) throws Exception {
		...
		try {
			...
			pedido_Pieza.setEstado_pedido(estado_PedidoAssemb.getEstado_Pedido(modificado.getEstado_pedido()));
...
<<<<<<< .mine
		...
		try {
			...
			Vector<Pedido_Pieza> pedidos_Pieza = (Vector<Pedido_Pieza>) accesoBD.buscarPorFiltro(Pedido_Pieza.class, "");
			for (int i = 0; i < pedidos_Pieza.size(); i++) {
				...
				Estado_PedidoAssembler estado_PedidoAssemb = new Estado_PedidoAssembler(accesoBD);
				pedido_PiezaDTO.setEstado_pedido(estado_PedidoAssemb.getEstado_PedidoDTO(pedidos_Pieza.elementAt(i).getEstado_pedido()));
