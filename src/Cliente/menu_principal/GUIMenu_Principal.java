package cliente.menu_principal;
...
public class GUIMenu_Principal {
	...
	private MediadorMenu_Principal mediador;
	...
	public MediadorMenu_Principal getMediador() {
		return mediador;
	}

	public void setMediador(MediadorMenu_Principal mediador) {
