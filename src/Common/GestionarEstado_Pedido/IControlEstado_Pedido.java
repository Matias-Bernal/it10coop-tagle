...
public interface IControlEstado_Pedido extends Remote{
	...
	public Vector<Estado_PedidoDTO> obtenerEstado_Pedido(Long id)throws Exception;
	...
	public Estado_PedidoDTO buscarEstado_Pedido(String estado_pedido) throws Exception;
