...
//	private String hostServer =RootAndIp.getIp();
	...
	private IControlOrden_Recurso controlOrden_Recurso = null;
	...
	public void iniciar() throws Exception {
		...
		nombreServer = "rmi://" + ip + "/IControlOrden_Recurso";
		setControlOrden_Recurso((IControlOrden_Recurso)Naming.lookup(nombreServer));
	...
	public IControlOrden_Recurso getControlOrden_Recurso() {
		return controlOrden_Recurso;
	}

	public void setControlOrden_Recurso(IControlOrden_Recurso controlOrden_Recurso) {
		this.controlOrden_Recurso = controlOrden_Recurso;
	}
