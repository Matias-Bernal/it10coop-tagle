...
public class Servidor {
	...
	private ControlOrden_Recurso controlOrden_Recurso = null;
	...
	public void iniciar() throws Exception {
		...
		this.name = "rmi://" + this.ip + "/IControlOrden_Recurso";
		Naming.rebind(this.name, this.controlOrden_Recurso);
		System.out.println("Nombre: " + this.name);
	...
	public ControlOrden_Recurso getControlOrden_Recurso() {
		return controlOrden_Recurso;
	}

	public void setControlOrden_Recurso(ControlOrden_Recurso controlOrden_Recurso) {
