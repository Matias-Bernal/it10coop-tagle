...
public class GUIAltaPedido extends JFrame{
	...
	public GUIAltaPedido(final MediadorPedido medidador, String nombre_reclamante, String email, String telefono) {
	 ...
	 */
	public GUIAltaPedido(final MediadorPedido medidador) {
		this.medidador = medidador;		
		initialize();
		SetVisible(true);
	}
