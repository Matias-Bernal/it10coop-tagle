...
public class GUIReclamo extends JFrame{
	...
	private MediadorReclamos mediador;
	...
	public GUIReclamo(MediadorReclamos mediadorRepuesto) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(GUIReclamo.class.getResource("/cliente/imagenes/tagle.ico")));
		setResizable(false);
