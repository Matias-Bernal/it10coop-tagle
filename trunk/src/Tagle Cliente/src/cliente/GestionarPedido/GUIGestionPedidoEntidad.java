...
public class GUIGestionPedidoEntidad extends JFrame {
	...
	public GUIGestionPedidoEntidad(MediadorPedido mediadorRegistrante) {
		...
		setTiposRegistrantes(new String[] {"Entidad", "Agente"});
		initialize();
	...
	public void initialize(){
		...
		btnActualizar.setBounds(939, 138, 315, 23);
	...
	public String[] getTiposRegistrantes() {
		return tiposRegistrantes;
	}

	public void setTiposRegistrantes(String[] tiposRegistrantes) {
		this.tiposRegistrantes = tiposRegistrantes;
	}
}