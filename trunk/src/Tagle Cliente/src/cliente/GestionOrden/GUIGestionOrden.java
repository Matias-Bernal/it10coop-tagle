...
public class GUIGestionOrden extends JFrame {
	...
	public void initialize(){
		...
		btnModificar.setBounds(484, 50, 220, 23);
		...
		btnEliminar.setBounds(484, 84, 220, 23);
		...
		btnActualizar.setBounds(484, 118, 220, 23);
	...
	public void filtrarPorEstado(){
		...
		for (int i=0; i< usuarios.size();i++){
			...
			Pattern pat = Pattern.compile(".*"+filtro+".*");
			Matcher mat = pat.matcher(usuario.elementAt(5).toLowerCase());
			if (mat.find()) {
				datos.add(usuario);
			} 
		}
	...
	public void cargarDatos(){
		...
		anchos.add(chico);
		nombreColumnas.add("Estado Reclmamo");//2
		anchos.add(grande);
		nombreColumnas.add("Fecha Apertura");//3
		anchos.add(chico);
		nombreColumnas.add("Fecha Cierre");//4
		anchos.add(chico);
		nombreColumnas.add("Estado Orden");//5
		anchos.add(mediano);
		nombreColumnas.add("Numero Recurso");//6
		anchos.add(chico);
